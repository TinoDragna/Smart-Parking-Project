    ...
    <div class="row" style="margin: 0;">
        ...
        <div class="col-sm-6" style="padding: 10px;">
            <div
                ...
                <div style="text-align: center; margin-top: 10px;">
                    ...
                    <div class="row" style="margin: 0; justify-content: center;">
                        <div class="col-sm-6" style="padding: 5px;">
                            ...
                            <div
                                style="border: 2px solid #006289; border-radius: 5px; overflow: hidden; background-color: #000; display: flex; align-items: center; justify-content: center; height: 240px;">
                                <img id="live_video_entry" src="https://iot.eiu.com.vn/pi5/?action=stream"
                                    alt="Entrance Camera Offline" style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                        </div>
                        <div class="col-sm-6" style="padding: 5px;">
                            ...
                            <div
                                ...
                                <img id="live_video_exit" src="https://iot.eiu.com.vn/pi5Picam/stream.mjpg"
                                    alt="Exit Camera Offline" style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-top: 15px;">
                    <h5 style="color: #555; text-align: left; padding-left: 5px; font-family: monospace;">System
                        Terminal</h5>
                    <div id="terminal_logs"
                        style="height: 150px; border: 1px solid #333; overflow-y: auto; background: #1e1e1e; color: #00ff00; border-radius: 5px; padding: 10px; font-family: monospace; font-size: 13px; text-align: left; white-space: pre-wrap;">
                        Connecting to terminal...</div>
                </div>
        ...
        fetch('http://127.0.0.1:5001/logs')//('http://172.16.10.168:5001/logs')
            ...
            .then(logs => {
                ...
                logs.forEach(log => {
                    ...
                    html += `<div style="color:${color}">${log}</div>`;
                });
