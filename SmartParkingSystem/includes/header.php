                ...
                <ul>
                    ...
                    <li <?php if($current == 'data') {echo 'class="current"';} ?>><a href="#" style="font-family: sans-serif;font-weight: bold;">Data</a>
                        <ul class="sub-menu">
                            ...
                            <!-- thêm payment -->
                            <li><a href="/Smart-Parking-Project/SmartParkingSystem/payment.php" style="font-family: 'Saira', sans-serif;font-weight: bold;">Payment User</a></li>
                            <!-- admin confirm -->
                            <li><a href="/Smart-Parking-Project/SmartParkingSystem/payment_admin.php"style="font-family: 'Saira', sans-serif;font-weight: bold;">Payment Admin</a></li>
                        </ul>
                    </li>
