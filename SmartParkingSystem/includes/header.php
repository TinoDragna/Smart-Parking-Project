                ...
                <ul>
                    ...
                    <li <?php if($current == 'data') {echo 'class="current"';} ?>><a href="#" style="font-family: sans-serif;font-weight: bold;">Data</a>
                        <ul class="sub-menu">
                            ...
                            <!-- user -->
                            <li><a href="/Smart-Parking-Project/SmartParkingSystem/user_payment.php" style="font-family: 'Saira', sans-serif;font-weight: bold;">Payment User</a></li>
                            <!-- admin confirm -->
                            <li><a href="/Smart-Parking-Project/SmartParkingSystem/admin_payment.php"style="font-family: 'Saira', sans-serif;font-weight: bold;">Payment Admin</a></li>
                        </ul>
                    </li>
