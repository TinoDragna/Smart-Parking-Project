                ...
                <ul>
                    <li <?php if ($current == 'home') {
                        echo 'class="current"';
                            ...
                            href="/Smart-Parking-Project/SmartParkingSystem/index.php"
                            style="font-family: sans-serif;font-weight: bold;">Home</a></li>
                    <li <?php if ($current == 'control') {
                        echo 'class="current"';
                    } ?>><a
                            href="/Smart-Parking-Project/SmartParkingSystem/control.php"
                            style="font-family: sans-serif;font-weight: bold;" id="activeControl"> Slot Control</a></li>
                    <li <?php if ($current == 'path') {
                        echo 'class="current"';
                    } ?>>
                        <a href="/Smart-Parking-Project/SmartParkingSystem/path.php"
                            style="font-family: sans-serif;font-weight: bold;">Navigation</a>
                    </li>
                    <li <?php if ($current == 'data') {
                        echo 'class="current"';
                    } ?>><a href="#"
                            style="font-family: sans-serif;font-weight: bold;">Data</a>
                        <ul class="sub-menu">
                            ...
                            <!-- admin confirm -->
                            <li><a href="/Smart-Parking-Project/SmartParkingSystem/admin_payment.php"
                                    style="font-family: 'Saira', sans-serif;font-weight: bold;">Payment Admin</a></li>
                        </ul>
                    </li>
                    <li <?php if ($current == 'location') {
                        echo 'class="current"';
                    } ?>><a
